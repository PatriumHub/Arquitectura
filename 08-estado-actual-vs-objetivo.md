...
Stack: app PHP monolítica + BD MySQL (`patriumhub.sql` **0.8.2**) en Apache/phpMyAdmin, con integraciones WC/MP desde pantallas.

| Tema | Hoy | Siguiente |
|------|-----|-----------|
| Código app | MVP + presupuestos, estados/proyección, clientes, edición movimientos, UX móvil | Uso diario + pulido |
| BD | Schema **0.8.2** instalable en un solo SQL | Backups periódicos |
...
| Empresas | Resumen, caja, valuación, **Estados y proyección**, **Clientes** (servicios) | Proyecciones al día |
